...
Then, in one turn: say which you would pick and why, as reasoning, naming the assumption it rests on — and what would make this whole thing unnecessary. If that kills the project, say so plainly — a good outcome.
